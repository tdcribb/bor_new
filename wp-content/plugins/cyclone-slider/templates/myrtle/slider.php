...
<div class="cycloneslider cycloneslider-template-myrtle" id="cycloneslider-<?php echo $slider_id; ?>" style="width:<?php echo $slider_settings['width'];?>px;">
	<div class="cycloneslider-slides" style="height:<?php echo $slider_settings['height'];?>px">
