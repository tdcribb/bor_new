...
<div id="usp">
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<ul id="usp_list">
			...
			<li class="usp_title">
				<label for="user-submitted-title" class="usp_label"><?php _e('Title of Story'); ?></label>
				<div>
			...
			<li class="usp_tags">
				<label for="user-submitted-tags" class="usp_label"><?php _e('Tag People/Places/Events'); ?> <small><?php _e('(separate with commas)'); ?></small></label>
				<div>
			...
			<li class="usp_content">
				<label for="user-submitted-content" class="usp_label"><?php _e('Story Content'); ?></label>
				<div>
