...
<div id="user-submitted-posts">
	...
	<form method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-title">
			<label for="user-submitted-title"><?php _e('Title'); ?></label>
			<input name="user-submitted-title" type="text" value="" placeholder="<?php _e('Title'); ?>">
		</fieldset>
		<?php } if ($usp_options['usp_tags'] == 'show') { ?>
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php _e('Tag People/Places/Event Names'); ?></label>
			<input name="user-submitted-tags" id="user-submitted-tags" type="text" value="" placeholder="<?php _e('People/Places/Event Names'); ?>">
		</fieldset>
		...
		<fieldset class="usp-category">
			<label for="user-submitted-category"><?php _e('Category'); ?></label>
		...
		<fieldset class="usp-content">
			<label for="user-submitted-content"><?php _e('Story Content'); ?></label>
			<textarea name="user-submitted-content" rows="5" placeholder="<?php _e('Story Content'); ?>"></textarea>
		</fieldset>
