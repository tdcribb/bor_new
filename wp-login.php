...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	<div id="login">
		<h1><a class="login-bg" href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>">
			<img id="login-logo" src="/wp-content/images/logo.png" />
		</a></h1>
	<?php
...
function login_footer($input_id = '') {
	...
	// Don't allow interim logins to navigate away from the page.
	if ( ! $interim_login ): ?>
	<p id="backtoblog"><a href="/" title="<?php esc_attr_e( 'Are you lost?' ); ?>"><?php printf( __( '&larr; Back to %s' ), get_bloginfo( 'title', 'display' ) ); ?></a></p>
	<?php endif; ?>
